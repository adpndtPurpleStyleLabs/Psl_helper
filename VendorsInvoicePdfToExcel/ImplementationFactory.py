...
from VendorsInvoicePdfToExcel.VendorImplementations.Minakshidadoo import Minakshidadoo
...
class ImplementationFactory:
    def getImplementation(self, implementation, tables, text_data, table_by_tabula):
        ...
        elif implementation == "minakshidadoo":
            return Minakshidadoo(tables, text_data)
        else:
