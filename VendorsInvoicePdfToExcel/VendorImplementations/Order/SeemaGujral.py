...
from VendorsInvoicePdfToExcel.helper import extractNumbers
...
class SeemaGujral:
    ...
    def getInvoiceInfo(self):
        ...
        invoiceInfoTable = get_list_containing(self.tables[1], "Invoice no").split("\n")
        return {
            "invoice_number":
                invoiceInfoTable[indexOfContainsInList(invoiceInfoTable, "Invoice no") + 1].strip().split(" ")[0],
            ...
            if is_numeric(listOfParticulars[0]):
                ...
                for i in range(0, 3):
                    ...
                    if aItem.find("ORDER NO") != -1:
                        ...
                        aProductResult["po_no"] = extractNumbers(poNo)
                        break
